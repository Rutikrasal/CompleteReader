...
class GridstudentbookviewAdapter extends BaseAdapter {
    ArrayList<StudentsBookResponse.Datum> al_display_studentsbook;
    Context context;
    int originalprice,discountprice,temp;
    double discount;
    String language,date,quantity,strbookfree="0",TAG="TAG",toolbarid="book",str_bookid,str_bookname,str_authorname,str_publisher,str_isbn,str_category,str_price,str_discountprice,str_description,str_frontbookimage,str_indexbookimage,str_backbookimage;

    public GridstudentbookviewAdapter(Context context, ArrayList<StudentsBookResponse.Datum> al_display_studentsbook) {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        tvquantity.setText(al_display_studentsbook.get(i).getQuantity());
        final TextView tvauthornmae=v.findViewById(R.id. tv_authorname);
        tvauthornmae.setText(al_display_studentsbook.get(i).getAuthor());

        textView1.setPaintFlags(textView1.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        originalprice= Integer.parseInt(al_display_studentsbook.get(i).getPrice());
        discountprice= Integer.parseInt(al_display_studentsbook.get(i).getDiscount());
        discount = originalprice-discountprice;
        temp= (int) ((discount/originalprice)*100);
        textView3.setText(String.valueOf(temp)+"%");

        textView.setText(al_display_studentsbook.get(i).getBookName());
        textView1.setText("₹"+al_display_studentsbook.get(i).getPrice());
        textView2.setText("₹"+al_display_studentsbook.get(i).getDiscount());

      /*  Picasso
                .with(context)
                .load(al_display_studentsbook.get(i).getBookImage())
                .into(imageView);
*/  Picasso
                .get()
                .load(al_display_studentsbook.get(i).getBookImage())
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                str_bookid=al_display_studentsbook.get(i).getId().toString();
                str_bookname=textView.getText().toString();
                quantity=tvquantity.getText().toString();

                str_authorname=al_display_studentsbook.get(i).getAuthor();
                str_publisher=al_display_studentsbook.get(i).getPublisher();
                str_isbn=al_display_studentsbook.get(i).getCopyrightname();
                language=al_display_studentsbook.get(i).getLang();
                date=al_display_studentsbook.get(i).getCreateDate();
                str_price=al_display_studentsbook.get(i).getPrice();
                str_discountprice=al_display_studentsbook.get(i).getDiscount();
                str_description=al_display_studentsbook.get(i).getDescription().toString();
                str_frontbookimage=al_display_studentsbook.get(i).getBookImage();
                str_indexbookimage=al_display_studentsbook.get(i).getBookIndexImage();
                str_backbookimage=al_display_studentsbook.get(i).getBookBackImage();
