...
public class MyEventAdapter extends BaseAdapter {
    ...
    Context context;
    String eventid;
    public MyEventAdapter(Context context, ArrayList<MyEventResponse.Datum> al_display_myevent) {
        this.context=context;
        this.al_display_myevent=al_display_myevent;
    }

    @Override
    public int getCount() {
        return al_display_myevent.size();
    }
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        if (al_display_myevent.get(i).getPrice().matches("0"))
        {
        ...
        {
            textView3.setText("Offline"+"₹"+al_display_myevent.get(i).getPrice());

        }
        if (al_display_myevent.get(i).getOnprice().matches("0"))
        {
        ...
        {
            textView4.setText("Online"+"₹"+al_display_myevent.get(i).getOnprice());

        }
        textView.setText(al_display_myevent.get(i).getEventName());
        textView1.setText(al_display_myevent.get(i).getSpeaker());
        textView2.setText(al_display_myevent.get(i).getSpeciality());


        //textView2.setText(al_display_magazines.get(i).getDiscount());
        Picasso.get()

                .load(al_display_myevent.get(i).getUserfrontfile())
       ...
       */ imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                eventid=al_display_myevent.get(i).getId();
