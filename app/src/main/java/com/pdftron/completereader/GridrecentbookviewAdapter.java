...
class GridrecentbookviewAdapter extends BaseAdapter {
    ...
    public GridrecentbookviewAdapter(Context context, ArrayList<RecentBookResponse.Datum> al_display_recentbook) {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        tvquantity.setText(al_display_recentbook.get(i).getQuantity());
        final TextView tvauthornmae=v.findViewById(R.id. tv_authorname);
        tvauthornmae.setText(al_display_recentbook.get(i).getAuthor());

        textView1.setPaintFlags(textView1.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
        originalprice= Integer.parseInt(al_display_recentbook.get(i).getPrice());
        discountprice= Integer.parseInt(al_display_recentbook.get(i).getDiscount());
        discount = originalprice-discountprice;
        temp= (int) ((discount/originalprice)*100);
        textView3.setText(String.valueOf(temp)+"%");


        textView.setText(al_display_recentbook.get(i).getBookName());
        textView1.setText("₹"+al_display_recentbook.get(i).getPrice());
        textView2.setText("₹"+al_display_recentbook.get(i).getDiscount());
        Picasso
                .get()
                .load(al_display_recentbook.get(i).getBookImage())
                .into(imageView);
...
*/
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                str_bookid=al_display_recentbook.get(i).getId().toString();
                str_bookname=textView.getText().toString();
                quantity=tvquantity.getText().toString();
                language=al_display_recentbook.get(i).getLang();
                date=al_display_recentbook.get(i).getCreateDate();

                str_authorname=al_display_recentbook.get(i).getAuthor();
                str_publisher=al_display_recentbook.get(i).getPublisher();
                str_isbn=al_display_recentbook.get(i).getCopyrightname();
                str_price=al_display_recentbook.get(i).getPrice();
                str_discountprice=al_display_recentbook.get(i).getDiscount();
                str_description=al_display_recentbook.get(i).getDescription().toString();
                str_frontbookimage=al_display_recentbook.get(i).getBookImage();
                str_indexbookimage=al_display_recentbook.get(i).getBookIndexImage();
                str_backbookimage=al_display_recentbook.get(i).getBookBackImage();
