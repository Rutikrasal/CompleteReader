...
class GridstudentebookviewAdapter extends BaseAdapter {
    ...
    public GridstudentebookviewAdapter(Context context, ArrayList<StudenteBookResponse.Datum> al_display_studentebook) {
    ...
    public View getView(final int i, View convertView, ViewGroup viewGroup) {
        ...
        tvauthornmae.setText(al_display_studentebook.get(i).getAuthor());


        textView.setText(al_display_studentebook.get(i).getEbookName());
        if (al_display_studentebook.get(i).getIsFree().matches("1"))
        {
        ...
        else if (al_display_studentebook.get(i).getIsFree().matches("0"))
        {
            textView1.setPaintFlags(textView1.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG);
            originalprice= Integer.parseInt(al_display_studentebook.get(i).getPrice());
            discountprice= Integer.parseInt(al_display_studentebook.get(i).getDiscount());
            ...
            textView1.setText("₹"+al_display_studentebook.get(i).getPrice());
            textView2.setText("₹"+al_display_studentebook.get(i).getDiscount());
...
*/
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                str_bookid=al_display_studentebook.get(i).getId().toString();
                str_bookname=textView.getText().toString();
                str_authorname=al_display_studentebook.get(i).getAuthor();
                str_publisher=al_display_studentebook.get(i).getPublisher();
                str_isbn=al_display_studentebook.get(i).getCopyrightPerson();
                str_price=al_display_studentebook.get(i).getPrice();
                language=al_display_studentebook.get(i).getLang();
                str_discountprice=al_display_studentebook.get(i).getDiscount();
                str_description=al_display_studentebook.get(i).getDescription().toString();
                str_frontbookimage=al_display_studentebook.get(i).getBookImage();
                str_indexbookimage=al_display_studentebook.get(i).getBookIndexPage();
                str_backbookimage=al_display_studentebook.get(i).getBookBackImage();
                strbookfree=al_display_studentebook.get(i).getIsFree();
                strbooklink=al_display_studentebook.get(i).getBookFile();
